...
import java.sql.*;
import java.awt.*;
public class SGenre implements ActionListener{
	private JTable t;
	private JFrame f;
	...
	public void actionPerformed(ActionEvent e)  {
		if(e.getActionCommand().equals("Search")) {
			String Genre =title1.getText();
			if(Genre.equals(""))//null
				{
				JOptionPane.showMessageDialog(null,"Please enter Book's Genre."); //Display dialog box with the message
			}
			else {
		...
		try {
			...
			String query = "SELECT BookID,Title,Genre,AuthorName,Availability FROM Book WHERE Genre like ?";
