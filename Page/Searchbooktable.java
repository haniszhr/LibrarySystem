...
import java.sql.*;
import java.awt.*;
public class Searchbooktable implements ActionListener{
	private JTable t;
	private JFrame f;
	...
	public void actionPerformed(ActionEvent e)  {
		...
		try {
			...
			String query = "SELECT BookID,Title,Genre,AuthorName,Availability FROM Book WHERE Title like ?";
